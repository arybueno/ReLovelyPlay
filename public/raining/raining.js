...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function iniciarJogo() {
    ...
    if (!gameBox || !player || !item || !scoreDisplay || !livesDisplay || !startScreen || !startButton || !popupBtn) {
      console.error("Algum elemento do DOM não foi encontrado!");
      return;
    }
    ...
    function mostrarPopup(titulo, mensagem, imagem, acaoBotao) {
      if (!popup || !popupImg || !popupTitle || !popupMsg || !popupBtn) return;
